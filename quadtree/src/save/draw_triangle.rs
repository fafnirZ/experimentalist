...
use wgpu::{
    ...
    RenderPipelineDescriptor, SurfaceTexture, Texture, TextureFormat, TextureView, VertexAttribute,
...
impl State {
    pub async fn new(window: Arc<Window>) -> State {
        ...
        let vbo = State::init_vertex_buffers(&device, &queue, &vertices.to_vec());
